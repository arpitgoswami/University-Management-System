...
public class Dashboard extends javax.swing.JPanel {
    ...
    private void init() throws IOException {
        ...
        universityPanel.add(new JLabel("Faculty Users"));
        universityPanel.add(new JLabel(countMatchingRecords("./csv/registration.csv", "FACULTY", 2)));
        universityPanel.add(new JLabel("Student Users"));
        universityPanel.add(new JLabel(countMatchingRecords("./csv/registration.csv", "STUDENT", 2)));
